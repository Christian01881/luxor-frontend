...
<div class="container py-5">
    ...
    <div class="col-md-12 ">
      <div class="d-flex flex-wrap ">
        <div class="col-12 col-md-6 mb-4" v-for="(property, index) in properties" :key="property.id">
          <div class="card h-100 m-2">
            <img :src="`http://127.0.0.1:8000/storage/${property.images[0].path}`" alt="" class="card-img" v-if="property.images.length > 0">
            <img src="https://www.leonardospada.it/wp-content/uploads/2022/09/errore-404-pagina-non-trovata-1024x576.jpg" alt="Image-Not-Found" class="h-100" v-else>
            <div class="card-body">
